...
const fetchDescription = (name = "World") => {
  ...
  axios.get(`https://npcworldgen-env.eba-cj322dz4.us-east-1.elasticbeanstalk.com/class`)
    .then(classResponse => {
      ...
      return Promise.all([
        axios.get(`https://npcworldgen-env.eba-cj322dz4.us-east-1.elasticbeanstalk.com/name`, { params: { name } }),
        axios.get(`https://npcworldgen-env.eba-cj322dz4.us-east-1.elasticbeanstalk.com/description`, { params: { className: classNameConst } }), // Corrected the params object
        axios.get(`https://npcworldgen-env.eba-cj322dz4.us-east-1.elasticbeanstalk.com/stats`),
        axios.get(`https://npcworldgen-env.eba-cj322dz4.us-east-1.elasticbeanstalk.com/personality`, { params: { className: classNameConst } }),
        axios.get(`https://npcworldgen-env.eba-cj322dz4.us-east-1.elasticbeanstalk.com/skills`, { params: { className: classNameConst } })
      ]).then(responses => {
