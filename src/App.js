  ...
  const fetchDescription = (name = "World") => {
    ...
    axios.get(`https://api.npcworldgenerator.com/class`)
      .then(classResponse => {
        ...
        return Promise.all([
          axios.get(`https://api.npcworldgenerator.com/name`, { params: { name } }),
          axios.get(`https://api.npcworldgenerator.com/description`, { params: { className: classNameConst } }), // Corrected the params object
          axios.get(`https://api.npcworldgenerator.com/stats`),
          axios.get(`https://api.npcworldgenerator.com/personality`, { params: { className: classNameConst } }),
          axios.get(`https://api.npcworldgenerator.com/skills`, { params: { className: classNameConst } })
        ]).then(responses => {
